...
#include "../../../../../SOSForWindows/capturethread.h"
...
QT_MOC_LITERAL(4, 29, 13), // "threadRunning"
QT_MOC_LITERAL(5, 43, 6) // "status"

    },
    "CaptureThread\0resultReady\0\0s\0threadRunning\0"
    "status"
};
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->threadRunning((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureThread::resultReady)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CaptureThread::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureThread::threadRunning)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CaptureThread::resultReady(const QString & _t1)
{
...
// SIGNAL 1
void CaptureThread::threadRunning(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
