...
#ifndef DEFINEFLAGS
#define DEFINEFLAGS
//DEFINE_int32(num_threads, 10, "num threads for ASR model");
int32 FLAGS_num_threads = 10;
// TorchAsrModel flags
//DEFINE_string(model_path, "", "pytorch exported model path");
string FLAGS_model_path = "";
    // OnnxAsrModel flags
string FLAGS_onnx_dir = "";
//DEFINE_string(onnx_dir, "", "directory where the onnx model is saved");

// FeaturePipelineConfig flags
int32 FLAGS_num_bins = 80;
int32 FLAGS_sample_rate = 16000;
//DEFINE_int32(num_bins, 80, "num mel bins for fbank feature");
//DEFINE_int32(sample_rate, 16000, "sample rate for audio");

// TLG fst
string FLAGS_fst_path = "";
//DEFINE_string(fst_path, "", "TLG fst path");

// DecodeOptions flags
int32 FLAGS_chunk_size = 16;
int32 FLAGS_num_left_chunks = -1;
int32 FLAGS_max_active = 7000;
int32 FLAGS_min_active = 200;
int32 FLAGS_nbest = 10;
double FLAGS_ctc_weight = 0.5;
double FLAGS_rescoring_weight = 1.0;
double FLAGS_reverse_weight = 0.0;
double FLAGS_beam = 16.0;
double FLAGS_lattice_beam = 10.0;
double FLAGS_acoustic_scale = 1.0;
double FLAGS_blank_skip_thresh = 1.0;
double FLAGS_length_penalty = 0.0;
...
string FLAGS_dict_path = "";
string FLAGS_unit_path = "";
string FLAGS_context_path = "";
double FLAGS_context_score = 3.0;
...
int32 FLAGS_language_type = 0;
bool FLAGS_lowercase = true;
